...
- **เปลี่ยนนิสัยบอท (AI Persona):** เข้าไปแก้ตัวแปร `system_prompt` ข้างในไฟล์ `app/gemini.py` สามารถเสกให้บอทมันพูดจาน่ารักขึ้น, พูดเป็นภาษาไทยล้วน, หรือสั่งให้สวมบทเป็นตัวละครเฉพาะทางได้เลย
